...
export class CustomIconService {
    customIconLinks: LinksInterface[] = [
        ...
        { name: 'play', link: 'assets/custom_svg/Play.svg' },
        { name: 'files', link: 'assets/custom_svg/Files.svg' },
        { name: 'Down-chevron', link: 'assets/custom_svg/Down-chevron.svg' },
        ...
        {
            name: 'facebook',
            link: 'assets/custom_svg/social_network_logo/Facebook.svg',
        },
        {
            name: 'google',
            link: 'assets/custom_svg/social_network_logo/Google.svg',
        },
        {
            name: 'twitter',
            link: 'assets/custom_svg/social_network_logo/Twitter.svg',
        },
        {
            name: 'youtube',
            link: 'assets/custom_svg/social_network_logo/YouTube.svg',
        },
        {
            name: 'inst',
            link: 'assets/custom_svg/social_network_logo/Instagram.svg',
        },
        {
            name: 'linked',
            link: 'assets/custom_svg/social_network_logo/Linked-In.svg',
        },
        {
            name: 'telegram',
            link: 'assets/custom_svg/social_network_logo/telegram.svg',
        },
    ];
